...
% \ssrule{FW-REGISTER}{
%   a \in dom(\sigma) \quad T = \sigma(a)
% }{
%   \semanticFull {a} {\sigma}   {T} {\sigma}
% }
\ssrule{FW-RAWGET}{
  \semanticFull{e_1}  {\sigma}    {a}  {\sigma_1} \quad
  \semanticFull{e_2}  {\sigma_1}    {s}  {\sigma'} \\
...
% \ssrule{FW-SET-UPDATE}{
%   \semanticFull{e_1}{\sigma}{a}{\sigma_1} \quad
%   \semanticFull{e_2}{\sigma_1}{s}{\sigma_2} \quad
%   \semanticFull{e_3}{\sigma_2}{v}{\sigma_3} \\
%   T = \sigma_3[a] \quad  s \in dom(T)\\
 
%    \semanticFull{{\tt rawset}(e_1,e_2,e_3)}{\sigma_3}{T'}{\sigma'} \\
% }{
%   \semanticFull{e_1[e_2] = e_3}{\sigma}{\tt nil}{\sigma'}
% }
% \ssrule{FW-SET-NEW}{
%   \semanticFull{e_1}{\sigma}{a}{\sigma_1} \quad
%   \semanticFull{e_2}{\sigma_1}{s}{\sigma_2} \quad
%   \semanticFull{e_3}{\sigma_2}{v}{\sigma_3} \\
%   T = \sigma_3[a] \quad  s \notin dom(T)\\
%   f = T[{``\tt {\_}MT}"][{\tt ``\_\_newindex"}]\\
%  
%    \semanticFull{((f(T))(s))(v)}{\sigma_3}{v}{\sigma'} \\
% }{
%   \semanticFull{e_1[e_2] = e_3}{\sigma}{\tt nil}{\sigma'}
% }
\ssrule{FW-BINOP-RAW}{
